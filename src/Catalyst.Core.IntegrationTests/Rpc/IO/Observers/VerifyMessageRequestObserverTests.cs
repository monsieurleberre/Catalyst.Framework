...
namespace Catalyst.Core.IntegrationTests.Rpc.IO.Observers
{
    public sealed class VerifyMessageRequestObserverTests : ConfigFileBasedTest
    {
        ...
        public VerifyMessageRequestObserverTests(ITestOutputHelper output) : base(output, new[]
        {
        ...
        public void VerifyMessageRequestObserver_Should_Send_Correct_Response(string message, string signatureAndMessage, string publicKey, bool expectedResult)
        {
