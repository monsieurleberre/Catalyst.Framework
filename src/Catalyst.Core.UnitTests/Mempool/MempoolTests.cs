...
//            _memPool.Repository.ReadItem(Arg.Is<ByteString>(k => k.SequenceEqual(transaction.ToByteString())))
//               .Returns(mempoolDoc);
            
//            _memPool.Repository.TryReadItem(Arg.Is<ByteString>(k => k.SequenceEqual(transaction.ToByteString())))
//               .Returns(true);
//        }
...
//            var mempoolDocument = _memPool.Repository.ReadItem(_transactionBroadcast.ToByteString());
//            var expectedTransaction = _transactionBroadcast;
//            var transactionFromMemPool = mempoolDocument.Transaction;

//            transactionFromMemPool.STEntries.Single().Amount.Should().Be(expectedTransaction.PublicEntries.Single().Amount);
//            transactionFromMemPool.CFEntries.Single().PedersenCommit.Should().BeEquivalentTo(expectedTransaction.ConfidentialEntries.Single().PedersenCommitment);
...
//            _memPool.Repository.TryReadItem(Arg.Is(_transactionBroadcast.ToByteString()))
//               .Returns(true);
            
//            var retrievedTransaction = _memPool.Repository.TryReadItem(_transactionBroadcast.ToByteString());
...
//        {
//            _transactionBroadcast.ToByteString() = ByteString.Empty;
...
//        {
//            AddKeyValueStoreEntryExpectation(_transactionBroadcast);
//            _memPool.Repository.TryReadItem(_transactionBroadcast.ToByteString()).Should().BeTrue();
//        }
