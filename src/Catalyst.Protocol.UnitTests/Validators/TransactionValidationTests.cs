...
//        {
//            GenerateTransaction(TransactionType.Public);
//            _transactionBroadcast.ContractEntries[0].Amount = 0;
//            _transactionBroadcast.ContractEntries[0].Data = ByteString.CopyFromUtf8("MyCallMethod()");
//            GenerateSignature();
...
//        {
//            GenerateTransaction(TransactionType.Public);
//            _transactionBroadcast.ContractEntries[0].Base.Recipient = new PublicKey();
//            _transactionBroadcast.ContractEntries[0].Data = ByteString.CopyFromUtf8("SmartContractCallData(1,1)");
//            GenerateSignature();
